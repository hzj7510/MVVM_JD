...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-IOSProjectInit/MJExtension.framework"
  install_framework "Pods-IOSProjectInit/MJRefresh.framework"
  install_framework "Pods-IOSProjectInit/Masonry.framework"
